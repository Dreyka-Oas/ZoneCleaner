...
import oas.work.zone_cleaner.init.ZoneCleanerModCommands;
...
public class ZoneCleanerMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(ZoneCleanerMod.class);
	public static final String MODID = "zone_cleaner";
